"""
Servicio para Cámara Vehicular Cédula - Canal 4 (con recorte)
"""
...
class CamaraVehicularCedula(ServicioCapturadorConCrop):
    """Servicio de captura para Cámara Vehicular Cédula (Canal 4) con recorte"""
